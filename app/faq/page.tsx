...
const faqsForSchema = [
  { question: 'What is Go4Garage?', answer: "Go4Garage is India's first AI-powered automobile intelligence platform with 6 products solving 85 problems across the EV ecosystem." },
