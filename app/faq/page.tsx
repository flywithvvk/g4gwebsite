...
const faqsForSchema = [
  { question: 'What is Go4Garage?', answer: "Go4Garage is India's first AI-powered automobile intelligence platform with 7 products solving 85 industry problems across the EV ecosystem." },
