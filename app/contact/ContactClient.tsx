...
const contactMethods = [
  { icon: 'mail', title: 'Email', detail: 'go4garageofficial@gmail.com', href: 'mailto:go4garageofficial@gmail.com', sub: 'We respond within 2 hours' },
  { icon: 'call', title: 'Phone', detail: '+91 9110 973 504', href: 'tel:+919110973504', sub: 'Mon-Fri, 9am-6pm IST' },
  { icon: 'location_on', title: 'Headquarters', detail: 'Patna, Bihar, India', href: 'https://maps.google.com/?q=Patna+Bihar+India', sub: 'EST. 2024' },
];
...
export default function ContactClient() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setIsLoading(true);
    try {
      const res = await fetch('https://formspree.io/f/go4garageofficial@gmail.com', {
        method: 'POST',
      ...
      window.open(`mailto:go4garageofficial@gmail.com?subject=${subject}&body=${body}`);
    }
    setIsLoading(false);
  };
